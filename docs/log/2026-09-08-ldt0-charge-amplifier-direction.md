...
LDT0-028K の容量をデータシート値の `480pF`、最大出力を記憶ベースの見積もりで
`80Vpp`(おおむね `±40Vpeak`)とすると、ピーク電荷は次の通りになる。開放電圧の
実測値は[2026-08-19の実測](2026-08-19-ldt0-028k-oc-voltage-measurement.md)で
`63Vpp`であり、`80Vpp`はこれに安全マージンを見て採用した数字であって実測値では
ない。
...
見積もり最大相当でも出力はおおむね `1.65V±0.87V` (`0.78〜2.52V`)に収まり、
